...
export class EditPublicationComponent {
  ...
  constructor(private scientistService: ScientistService, private userService: UserService, private route: ActivatedRoute, private router: Router){}
  ...
  editarPublicacion(){
    ...
    //(document.getElementById('experienciaAñosPublicacion') as HTMLInputElement).value;
    const experienciaMeses = this.expMonthsPublicacion;
    //(document.getElementById('experienciaMesesPublicacion') as HTMLInputElement).value;
